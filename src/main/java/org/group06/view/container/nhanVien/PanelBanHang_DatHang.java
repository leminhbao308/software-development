...
public class PanelBanHang_DatHang extends javax.swing.JPanel {
    ...
    public PanelBanHang_DatHang(NhanVien nhanVien, Manager_QuanAo qlQuanAoMua) {
        this.nhanVien = nhanVien;
        daoQuanAo = new DAO_QuanAo(connection);
        dsLoaiQuanAo = daoQuanAo.getAllLoaiQuanAo();
        qlQuanAo = new Manager_QuanAo(connection);
                    ...
                    if (file.exists()) {
                        ...
                        if (response == JOptionPane.YES_OPTION) {
                            ...
                            try {
                                ...
                                new Thread(() -> {
                                    if (kh.getEmail() != null) {
                                        EmailCreator.sendEmailWithAttachment(kh.getEmail(), "Hóa đơn mua hàng", "Đây là hóa đơn mua hàng của bạn!", path);
                                    }
                                }).start();
    ...
    public Manager_QuanAo getDonHangTam() {
        return qlQuanAoMua;
    }
